    ...
    <div className={cx('home')}>
      ...
      <div style={{ margin: "auto auto", width: "80%", }}>
        ...
        <div>
          ...
          <div className={cx('imgPartner')} style={{ display: "grid", gridTemplateColumns: "200px 200px 200px 200px 200px", justifyContent: "center", gap: 20, textAlign: "center" }}>
            <div>
              <Link style={{ textDecoration: "none" }} to={"http://riam.com.vn/"} target="_blank" >
                <img style={{ width: "100%" }} height={"200px"} src="https://viu.edu.vn/media/ZiAkwT1jbfSqYBAPHx0jVr0sO9gdaM2b75yIN3VnXTON1bUxrwKR8L9YaZEAGbni.png" alt="" />
            ...
            <div>
              <Link style={{ textDecoration: "none" }} to={"https://moet.gov.vn/"} target="_blank">
                <img style={{ width: "100%" }} height={"200px"} src="https://viu.edu.vn/media/j5JOBtJDbcCyme-sa9EsLMj_dd5PiYcLqcA_XGQphc3S_45lNLAu7UjDh_0sSb-W.png" alt="" />
            ...
            <div>
              <Link style={{ textDecoration: "none" }} to={"https://www.haui.edu.vn/vn"} target="_blank">
                <img style={{ width: "100%" }} height={"200px"} src="https://viu.edu.vn/media/NFI6vBcr_XSNUbLvGk7NKFKpz66bo6b9d4IWyGOHvcC-DoQEytOEX3Ook5bLsGV6.png" alt="" />
            ...
            <div>
              <Link style={{ textDecoration: "none" }} to={"https://iuh.edu.vn/"} target="_blank">
                <img style={{ width: "100%" }} height={"200px"} src="https://viu.edu.vn/media/4j_QNM-7-vf__mV1q__N2OMPKE9kOlTvwN3pze34IlXHi74u1ELeTj8GNAFgMZNG.png" alt="" />
            ...
            <div>
              <Link style={{ textDecoration: "none" }} to={"https://iuh.edu.vn/"} target="_blank">
                <img style={{ width: "100%" }} height={"200px"} src="https://viu.edu.vn/media/xEVYHt2V5jVCAyBvU4GLctwZPShm8D4BljYd-vZaSp0fJw4Fh87h4FrDRU9jD94X.jpg" alt="" />
